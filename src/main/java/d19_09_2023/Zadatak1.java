...
public class Zadatak1 {
    public static void main(String[] args) {
        ...
        SuperKartica kartica = new SuperKartica(156, "Pera Peric", 10);
        StaklenaAmbalaza ambalaza = new StaklenaAmbalaza("1222548", "Sok 2", 80, 90, 0, false, 122);

        korpa.dodajAmbalazu(new Tetrapak("12546545", "Cokoladno mleko", 50, 60, true, 70));
        korpa.dodajAmbalazu(new StaklenaAmbalaza("125555", "Sok", 60, 70, 40, true, 120));
        korpa.dodajAmbalazu(new Tetrapak("456456", "Mleko", 100, 150, false, 180));
