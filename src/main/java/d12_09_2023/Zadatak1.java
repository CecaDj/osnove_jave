...
public class Zadatak1 {
    public static void main(String[] args) {
        FizickoLice pera = new FizickoLice("Pera Peric","0125487", "2012990785215",false);
        FizickoLice marko = new FizickoLice("Marko Markovic", "0984569", "0807988458773", true);
        Ugovor ugovor = new Ugovor("13.09.2023.", pera, marko,200500.0, "Marka Miljanova 5, Novi Sad");
