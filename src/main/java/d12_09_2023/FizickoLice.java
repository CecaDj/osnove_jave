...
public class FizickoLice {
    ...
    private String jmbg;
    private boolean prethodnaKupovina;

    public FizickoLice(String jmbg){
        this.jmbg = jmbg;
    }

    public FizickoLice(String punoIme, String brLicneKarte, String jmbg, boolean prethodnaKupovina){
        this.punoIme = punoIme;
        this.brLicneKarte = brLicneKarte;
        this.jmbg = jmbg;
        this.prethodnaKupovina = prethodnaKupovina;
    }

    public void stampaj(){
        System.out.print(this.punoIme + ", Broj licne karte: " + this.brLicneKarte);
    }
    ...
    public boolean getPrethodnaKupovina(){
        return this.prethodnaKupovina;
    }

    public void setPrethodnaKupovina(boolean prethodnaKupovina) {
        this.prethodnaKupovina = prethodnaKupovina;
    }
}
