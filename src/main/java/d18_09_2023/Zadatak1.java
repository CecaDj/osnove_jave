...
public class Zadatak1 {
    public static void main(String[] args) {
        VideoPlayer player = new VideoPlayer(60,50,0,144);
        TimeControl timeControl = new TimeControl(true);
        AudioControl audioControl = new AudioControl(false);
        QualityOptimizerControl quality = new QualityOptimizerControl(15);

        timeControl.izvrsiAkciju(player);
        audioControl.izvrsiAkciju(player);
